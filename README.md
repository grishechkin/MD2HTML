...
* Разработан конвертер из [Markdown](https://ru.wikipedia.org/wiki/Markdown)-разметки в [HTML](https://ru.wikipedia.org/wiki/HTML).
* Конвертер поддерживает следующие возможности:
    ...
    * Поддержка ```[ссылок с _выделением_](https://kgeorgiy.info): <a href='https://kgeorgiy.info'>ссылок с <em>выделением</em></a>```
